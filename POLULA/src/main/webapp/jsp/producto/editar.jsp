...
<div class="container-fluid" id="container">
    ...
    <form id="formEditarProducto" action="producto" method="POST">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-danger text-white">
                        <h5 class="modal-title" id="modalErrorLabel"><i class="fas fa-exclamation-circle"></i> Error al Actualizar Producto</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <p>Por favor, verifica los campos del formulario antes de continuar.</p>
        ...
        <!-- Modal de Producto Actualizando -->
        <div class="modal fade" id="modalProductoActualizando" tabindex="-1" aria-labelledby="modalProductoActualizandoLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-warning text-dark">
                        <h5 class="modal-title" id="modalProductoActualizandoLabel"><i class="fas fa-spinner fa-spin"></i> Actualizando Producto</h5>
                    </div>
                    <div class="modal-body">
        ...
        <div class="modal fade" id="modalProductoActualizado" tabindex="-1" aria-labelledby="modalProductoActualizadoLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-success text-white">
                        <h5 class="modal-title" id="modalProductoActualizadoLabel"><i class="fas fa-check-circle"></i> Producto Actualizado</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                formEditarProducto.addEventListener("submit", function (event) {
                    ...
                    if (formularioValido) {
                        const modalActualizando = new bootstrap.Modal(document.getElementById("modalProductoActualizando"));
                        const modalActualizado = new bootstrap.Modal(document.getElementById("modalProductoActualizado"));

                        modalActualizando.show();

                        setTimeout(function () {
                            modalActualizando.hide();
                            modalActualizado.show();

                            setTimeout(function () {
                                modalActualizado.hide();

                                // Redirigir al listado después de actualizar
                                window.location.href = "index.jsp?page=listarProducto"; // Cambia "/ruta-a-tu-listado" por la URL de tu listado
                            }, 2000);
                        }, 2000);
                    } else {
