...
<div class="container-fluid" id="container">
    ...
    <div class="d-flex justify-content-end mb-3">
        ...
        <a style="background: #dc3545" href="cliente?action=Inactivos" class="btn btn-danger ms-2">
        ...
        <thead class="table-dark">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a style="background: #dc3545" href="cliente?action=eliminar&id=<%= cliente.getClienteID() %>" class="btn btn-danger btn-sm" title="Eliminar">
