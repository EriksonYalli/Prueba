...
<body>
<h2>Hola ${sessionScope.usuario.nombre}</h2>
<div class="d-flex">
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="nav flex-column w-100">
            ...
            <a href="${ContextPath}/demo1/logon.jsp" class="nav-link d-flex align-items-center mb-3">
                <i class="bi bi-person-gear me-2"></i> Venta
            </a>
        </nav>
    </div>
            ...
            <div class="container-fluid">
                <div id="content" class="container-fluid mt-4"> <!-- Cambiado a container-fluid -->
                    <c:choose>
                        ...
                        <c:when test="${param.page == 'logon' || param.page == null}">
                            <jsp:include page="logon.jsp"></jsp:include>
                        </c:when>
                    </c:choose>
                </div>
            </div>
