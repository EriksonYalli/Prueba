...
<div class="d-flex">
  ...
  <div class="p-4 flex-grow-1 content">
    ...
    <div class="Busqueda mb-1">
      <form action="${pageContext.request.contextPath}/listarCompraInactivo" method="get" class="d-flex" onsubmit="return validateForm()">
    ...
    <a href="/listarCompras" class="btn btn-primary">
      ...
      <table class="table mt-4" id="inactivePartsTable">
        ...
        <c:forEach var="repuestoI" items="${partsI}">
          <tr>
            ...
            <td>
              <form action="/restaurarAlmacen" method="post" style="display:inline;" id="restoreForm-${repuestoI.id}">
