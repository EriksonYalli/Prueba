...
<div class="layout">
    ...
    <div class="content">
        ...
        <form action="/ComprasAlmacen" method="get" class="mb-4">
            <div class="row">
        ...
        <div class="mb-3">
            <a href="/Registrar_ComprasAlmacen" class="btn btn-primary">
                <i class="fas fa-plus"></i> Registrar Nueva Compra
            </a>
            <a href="/ComprasAlmacen" class="btn btn-secondary">Restaurar</a>
        </div>
