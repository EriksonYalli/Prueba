...
<div class="d-flex">
    ...
    <div class="p-4 flex-grow-1 content">
        ...
        <div class="Busqueda mb-1">
            <form action="${pageContext.request.contextPath}/listarCompras" method="get" class="d-flex" onsubmit="return validateForm()">
        ...
        <a href="/listarCompraInactivo" class="btn btn-dark">
            <i class="bi bi-eye-slash"></i> Inactivos
        </a>

        <a href="${pageContext.request.contextPath}/listarCompras" class="btn btn-primary custom-btn">Restaurar tabla</a>
        ...
        <div class="modal fade" id="addRepuestoModal" tabindex="-1" aria-labelledby="addRepuestoModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <form action="/createAlmacen" method="post" id="addRepuestoForm">
                        <!-- Header -->
                ...
                <c:forEach var="repuesto" items="${parts}">
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="/eliminarAlmacen" method="post" style="display:inline;" onsubmit="return confirmDelete(event, this);">
        ...
        <div class="modal fade" id="editRepuestoModal" tabindex="-1" aria-labelledby="editRepuestoModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="/editarAlmacen" method="post" id="editRepuestoForm">
