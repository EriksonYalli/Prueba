        ...
        <div class="row g-3">
          <form id="purchaseForm">
            <div class="row g-3">
              ...
              <div class="col-md-3">
                <div class="form-floating">
                  <input type="number" id="priceUnit" class="form-control" min="0" step="0.01"
                         placeholder="Precio Unitario" oninput="validatePrice(this)">
              ...
              <div class="col-md-3">
                <div class="form-floating">
                  <input type="number" id="quantity" class="form-control" min="1" step="1" placeholder="Cantidad"
