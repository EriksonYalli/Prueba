...
<head>
    ...
    <style>
        ...
        .main-content {
            margin-left: 250px;
            padding: 10px; /* Eliminamos padding para maximizar el uso del espacio */
...
<div class="d-flex">
    ...
    <div class="sidebar" id="sidebar">
        <div class="logo">
            <img src="img/Logo.png" alt="Logo del Negocio"> <!-- Reemplaza con tu logo -->
            <h2>Sabor de Casa</h2>
        </div>
        <nav class="nav flex-column w-100">
            ...
            <a href="index.jsp?page=historial" class="nav-link d-flex align-items-center mb-3">
                <i class="bi bi-bar-chart-line me-3"></i> Historial Venta
            </a>
        </nav>
    </div>
                ...
                <div id="content" class="container-fluid mt-4"> <!-- Cambiado a container-fluid -->
                    <c:choose>
                        ...
                        <c:when test="${param.page == 'venta_detalle' || param.page == null}">
                            <jsp:include page="jsp/venta/venta.jsp"></jsp:include>
                        </c:when>
                        <c:when test="${param.page == 'historial' || param.page == null}">
                            <jsp:include page="jsp/HistorialVenta/Historial.jsp"></jsp:include>
                        </c:when>
                        <c:when test="${param.page == 'detalleVenta' || param.page == null}">
                            <jsp:include page="jsp/HistorialVenta/Detalle.jsp"></jsp:include>
                        </c:when>
                    </c:choose>
                </div>
            </div>
